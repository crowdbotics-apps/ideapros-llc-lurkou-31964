...
## Project Structure
    ...
    ├── ideapros_llc_lurkou_31964  # Django project configurations
...
1. Clone this repo and `cd ideapros_llc_lurkou_31964`
...
2. Clone this repo and `cd ideapros_llc_lurkou_31964`
